...
# Mostly needed this for pure stan approach
...
# Create separate data frames for different truncation levels
...
# Conflicted package really fucks things up with Stan. Make sure it's not loaded.
...
# Generate posterior samples for the anti-US protest models
...
# Generate posterior draws for the anti-US military protest models
...
# Combine posterior draws into a single object. 
# Also edit draw indices and variable/model labels for plotting.
...
# Calculate the percent positive/negative for posterior groupings.
  ate.pd <- ate.fig.com %>% 
